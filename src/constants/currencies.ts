...
export const FEATURED_CURRENCY_CODES = ["LKR", "USD"] as const;

export const SUPPORTED_CURRENCIES: CurrencyInfo[] = [
  { code: "LKR", name: "Sri Lankan Rupee", symbol: "Rs", locale: "en-LK", flag: "🇱🇰", featured: true },
  { code: "USD", name: "US Dollar", symbol: "$", locale: "en-US", flag: "🇺🇸", featured: true },
